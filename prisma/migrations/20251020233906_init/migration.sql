...
-- CreateIndex
CREATE INDEX "Plan_goalWeight_startWeight_idx" ON "Plan"("goalWeight", "startWeight");

-- CreateIndex
CREATE UNIQUE INDEX "Like_planId_userId_key" ON "Like"("planId", "userId");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan"("id") ON DELETE CASCADE ON UPDATE CASCADE;
