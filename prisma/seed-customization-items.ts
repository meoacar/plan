...
async function main() {
  ...
  const backgrounds = [
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&q=80",
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400&q=80",
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80",
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&q=80",
    ...
    },
    {
      ...
      code: "nature_zen_bg",
      name: "Doğa Huzuru",
      description: "Meditasyon ve yoga rozetleriyle açılır",
      cssClass: "bg-nature-zen",
    ...
    {
      type: "BACKGROUND" as const,
      code: "mountain_peak_bg",
      name: "Zirve",
      description: "Hedeflerine ulaşanlar için",
    ...
    },
    {
      ...
      code: "ocean_calm_bg",
      name: "Sakin Okyanus",
      description: "Huzurlu bir arka plan",
      cssClass: "bg-ocean",
      imageUrl: "https://images.unsplash.com/photo-1505142468610-359e7d316be0?w=1200&q=80",
      previewUrl: "https://images.unsplash.com/photo-1505142468610-359e7d316be0?w=400&q=80",
      unlockCondition: "10 rozet",
      badgeCount: 10,
      order: 5,
    },
    {
      type: "BACKGROUND" as const,
      code: "sunrise_energy_bg",
      name: "Gün Doğumu",
      description: "Yeni başlangıçlar için",
      cssClass: "bg-sunrise",
      imageUrl: "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=1200&q=80",
      previewUrl: "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=400&q=80",
      unlockCondition: "7 Gün Aktif rozeti",
      badgeType: BadgeType.ACTIVE_7_DAYS,
      order: 6,
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&q=80",
    ...
    },
    {
      ...
      previewUrl: "https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=400&q=80",
    ...
    },
    {
      ...
      code: "aurora_bg",
      name: "Kuzey Işıkları",
      description: "Efsanevi bir arka plan",
      cssClass: "bg-aurora",
