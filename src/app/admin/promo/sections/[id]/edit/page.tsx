...
export default function EditPromoSectionPage() {
  ...
  const fetchSection = async () => {
    try {
      const res = await fetch(`/api/admin/promo/sections/${params.id}`);
      if (res.ok) {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mb-2">Tanıtım Bölümünü Düzenle</h1>
