        ...
        <div className="flex items-center h-16 md:justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative" ref={featuresMenuRef}>
              ...
              {featuresMenuOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 py-3 z-[9999] max-h-[80vh] overflow-y-auto">
